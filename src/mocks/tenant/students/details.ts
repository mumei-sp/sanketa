...
import { attendanceSubmissions } from '@/mocks/tenant/attendance/daily'
import { classTeacherOf, subjectTeacherOf } from '@/mocks/tenant/teachers/assignments'
import { activeTenant } from '@/mocks/_shared/tenant-context'
import { rng, int, pick, chance, type Rng } from '@/mocks/schools/_generate/random'
